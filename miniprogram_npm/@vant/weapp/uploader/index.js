...
(0, component_1.VantComponent)({
    ...
    methods: {
        ...
        onBeforeRead: function (file) {
            ...
            if (useBeforeRead) {
                res = new Promise(function (resolve, reject) {
                    _this.$emit('beforeRead', __assign(__assign({ file: file }, _this.getDetail()), { callback: function (ok) {
                            ok ? resolve() : reject();
                        } }));
                });
            }
        ...
        deleteItem: function (event) {
            ...
            //   lists:lists
            // })
            this.$emit('delete', __assign(__assign({}, this.getDetail(index)), { fileList: this.data.fileList[index] }));
        },
